...
\title{Path Planning and Control for Vertical Takeoff and Landing Aircraft}

% On the custom title page, use the same title, but format as you like
\customtitle{Path Planning and Control for Vertical Takeoff and Landing Aircraft}

% Your name goes here:
\author{Dean Benjamin Anderson}
...
\committeechair{Randal Beard}
\committeemember{David Long}
\committeemember{Brian Jeffs}

% Include any keywords you would like for your thesis/dissertation
\keywords{VTOL, B-Spline, RRT, differential flatness, system identification}
