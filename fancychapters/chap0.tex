...
UAVs take advantage of the vast airspace available over land, sea, and city to avoid the traffic inherent to civilization \cite{sabour2023applications}. 
...
They generate little to no lift from airflow over some sort of airfoil. 
