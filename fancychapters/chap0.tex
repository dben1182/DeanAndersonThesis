...
Today, aircraft are rarely flown manually by a direct remote control pilot. While manual control is fun for recreational purposes, it is hardly accurate or stable enough for many of the missions performed by UAVs. Most aircraft are now flown autonomously using autopilot stacks on the onboard computers. Many open source autopilots exist today, including Px4, Ardupilot, and Rosflight. Two books on writing an autopilot stack for airplane and rotorcraft UAVs were written and heavily influenced the research in this paper \cite{uav_book, vtol_book}.
