...
UAVs take advantage of the vast airspace available over land, sea, and city to avoid the traffic inherent to civilization \cite{sabour2023applications}. UAVs can reach remote locations in minutes what would otherwise take hours or days for humans and automobiles to reach, such as remote or mountainous areas with poor roads. 
...
Demand for better autopilots and controllers will continue to grow as the number of desired applications for UAVs increases.
...
Two books on writing an autopilot stack for airplane and rotorcraft UAVs were written and heavily influenced the research in this paper \cite{uav_book, vtol_book}.
...
A VTOL is defined as an airplane that can take off and land vertically \cite{Rehan_Akram_Shahzad_Shams_Ali_2022}. That is, they are rotorcraft and airplane hybrids, with airfoils to generate lift and vertical rotors to take off and land vertically. 
